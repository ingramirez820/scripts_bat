...
REM .bat con permisos de administrador perrón
:-------------------------------------
REM  --> Analizando los permisos
    IF "%PROCESSOR_ARCHITECTURE%" EQU "amd64" (
>nul 2>&1 "%SYSTEMROOT%\SysWOW64\cacls.exe" "%SYSTEMROOT%\SysWOW64\config\system"
...
REM   A PARTIR DE AQUÍ ESCRIBE EL CÓDIGO MAMALÓN PARA JUAKEAR LA NASA.
TITLE Bienvenido %USERNAME%, TERMINAL CON PERMISOS ADMINISTRATIVOS
cmd.exe start /k cmd.exe
